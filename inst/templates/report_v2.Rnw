...
\centering
\textbf{Documented Prenatal Contraceptive Counseling}
\end{minipage}
...
\begin{minipage}[t][0.28\textheight][t]{0.5\textwidth}
  ...
  row_spec(0, bold=T) %>%
  footnote(symbol="\\\\small Other inclues depo, pill, and condoms",
           escape=F)
  @
  }
  \vfill
...
\begin{minipage}[t][0.02\textheight][t]{\textwidth}
\centering
\textbf{Postpartum Outpatient Contraception (4-60 days) Q1 2020}
\end{minipage}
