...
\centering
\Large MICCA Quarterly Report for \Sexpr{ascribee_title} \Sexpr{start_month} - \Sexpr{end_month} \Sexpr{end_year}
\end{minipage}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\centering
{\LARGE Overview for Women Aged 15-44 Who Delivered}\\\par

\begin{minipage}[t][0.23\textheight][t]{0.3\textwidth}
