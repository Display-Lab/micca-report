...
\centering
\Large MICCA Quarterly Report for \Sexpr{ASCRIBEE_TITLES[RECIP]} \Sexpr{START_MONTH} - \Sexpr{END_MONTH} \Sexpr{END_YEAR}
\end{minipage}
...
\begin{minipage}[t][0.30\textheight][t]{0.5\textwidth}
  ...
  \fi
  \parbox{\textwidth}{\centering Delivering Women with a Documented Contraceptive Preference}
  \centering{
