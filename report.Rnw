...
\begin{minipage}[t][0.30\textheight][t]{0.5\textwidth}
  \strut\vspace*{-\baselineskip}\newline
  \parbox{\textwidth}{Long Acting Contraceptive Preference}
  << p2-mid-left, include=TRUE, message=FALSE, echo=FALSE>>=
    # DON"T INCLUDE A CAPTION.  It will bork the environment
    knitr::kable(p2_tbl_mid_left, booktabs=T, format="latex") # %>% kable_styling(latex_options="scale_down")
  @
  \vfill
  \makebox[\linewidth]{}
\end{minipage}\hfill
